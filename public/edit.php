...
if (isset($_GET['id'])) {
    ...
    if (!$note) {
        die('A jegyzet nem található!');
    }
} else {
    die('Hiányzik az azonosító!');
}
...
<head>
    ...
    <title>Jegyzet szerkesztése</title>
...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="max-w-2xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
        <h1 class="text-3xl font-bold mb-6 text-center text-blue-600">✏️ Jegyzet szerkesztése</h1>
        ...
        <form method="POST" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="6" required
                    class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-400 outline-none"><?= htmlspecialchars($note['content']) ?></textarea>
            </div>
